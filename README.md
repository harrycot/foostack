...
TODO: find a way to remove usage of "secret" set from system environment variable and used by crypto hmac. (exploring https://nodejs.org/docs/latest-v20.x/api/crypto.html#class-diffiehellman)
```
